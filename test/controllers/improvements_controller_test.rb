...
class ImprovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create improvement" do
    assert_difference('Improvement.count') do
      post improvements_url, params: { improvement: { listening: @improvement.listening, reading: @improvement.reading, student: @improvement.student, tutor: @improvement.tutor, writing: @improvement.writing } }
    end
  ...
  test "should update improvement" do
    patch improvement_url(@improvement), params: { improvement: { listening: @improvement.listening, reading: @improvement.reading, student: @improvement.student, tutor: @improvement.tutor, writing: @improvement.writing } }
